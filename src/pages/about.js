...
<div className="w-full py-10">
  <div className="relative max-w-4xl mx-auto">
    ...
    <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-4 sm:pb-6">
      <a
        href="/contact"
        className="bg-[#7b2979] hover:bg-[#9d3a9b] text-white font-semibold py-1.5 px-3 sm:py-2 sm:px-4 md:py-2 md:px-6 text-xs sm:text-sm md:text-base rounded-full shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300"
      >
        Enroll Now
      </a>
    </div>
            ...
            >
              ...
              <div className="mt-6">
                <a
                  href="/courses"
                  className="bg-[#7b2979] hover:bg-[#9d3a9b] text-white font-semibold py-2 px-6 rounded-full transition-all duration-300"
                >
                  Explore Courses
                </a>
              </div>
